...
const storageLockAction: ActionType<StorageLockTaskArguments> = async (
  ...
  console.log("excludeContracts:", excludeContracts);
  ...
  try {
    ...
    console.log("fullyQualifiedNames:", fullyQualifiedNames);
  } catch (error: any) {
  ...
  console.log("fullyQualifiedNames-after-excluding", fullyQualifiedNames);
